...
public class GJ24InstructionsText : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _instructionsText.text = "The foolish earthlings have got everything wrong! Cars smaller than buildings? We must help them! \n\n" +
                                 ...
                                 "Watch out! The stupid earthlings don’t realise we’re trying to help them! Their <color=#FF6400>tanks</color> are trying to <color=#FF6400>shoot us</color> down and are protected by anti-correction <color=#FF6400>shields</color>\n\n" +
